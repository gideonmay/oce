...
**[oce-0.17.1](https://github.com/tpaviot/oce/releases/tag/OCE-0.17.1)** (October 2015)
...
| ------------- | ------------- |  ------------- |------------- |
| [0.17.1](https://github.com/tpaviot/oce/releases/tag/OCE-0.17.1)  | No | October 2015 | 6.8.0 |
