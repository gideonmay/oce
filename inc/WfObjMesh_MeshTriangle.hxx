...
#ifndef _WfObjMesh_MeshTriangle_HeaderFile
#define _WfObjMesh_MeshTriangle_HeaderFile
...
public:
  ...
  //! empty constructor
  Standard_EXPORT WfObjMesh_MeshTriangle();
  
  //! create a triangle defined with the indexes of its three vertices
  //! and its orientation
  //! Raised if V1, V2 or V3 is lower than zero
  Standard_EXPORT WfObjMesh_MeshTriangle(const Standard_Integer V1, const Standard_Integer V2, const Standard_Integer V3, const Standard_Real Xn, const Standard_Real Yn, const Standard_Real Zn);
  ...
  DEFINE_STANDARD_RTTI(WfObjMesh_MeshTriangle)
...
#endif // _WfObjMesh_MeshTriangle_HeaderFile
